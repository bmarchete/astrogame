...
class QuestsSeeder extends Seeder
{
    public $quests = [
        ...
        [
            ...
            'type' => 2,
            'description' => 'Hubble, alám da classificação das galáxias, também irá nos falar um pouco sobre a teoria do universo em expanção e sobre sua pr�pria lei! ',
        ...
        [
            ...
            'type' => 2,
            'description' => 'Para fazer a espaçonave Voyager funcionar Sagan irá precisar de mais peças, talvez você possa comprar mais algumas em sua loja.',
            'objetivos' => 'Compre as peças da Voyager em sua loja!',
            'xp_reward' => 3750,
            'money_reward' => 0,
            'min_level' => 1,
            'max_level' => 0,
        ...
        [
            ...
            'type' => 2,
            'description' => 'Está na hora de montar a Voyager com as peças que você comprou, vamos nessa!',
            'objetivos' => 'Monte a Voyager',
            'xp_reward' => 3750,
            'money_reward' => 50,
            'min_level' => 1,
            'max_level' => 0,
        ...
        [
            ...
            'objetivos' => 'Pilote a Voyager pelo espaço cideral!',
            'xp_reward' => 3750,
            'money_reward' => 150,
            'min_level' => 1,
            'max_level' => 0,
        ...
        [
            ...
            'title' => 'Um mundo novo',
            'type' => 2,
            'description' => 'Você caiu em um mundo desconhecido cheio de perigos! Encontre a voyager para conseguir voltar para a Terra!',
            'objetivos' => 'Chegue atá a Voyager para voltar para casa',
            'xp_reward' => 3750,
            'money_reward' => 200,
            'min_level' => 1,
            'max_level' => 0,
