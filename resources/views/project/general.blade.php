...
<head>
    ...
    {!! Minify::stylesheet(['/vendor/uikit/css/uikit.gradient.css', '/css/project/main.css'])->withFullUrl() !!} 
    @yield('style')
...
<body>
    ...
    <div id="menu" class="uk-offcanvas">
        <div class="uk-offcanvas-bar">
            <ul class="uk-nav uk-nav-offcanvas">
                ...
                <!-- HACK // PLEASE FOR GOD'S SAKE, REMOVE THIS -->
                @endif
                ...
                <li @if ($page=='desastronautas' ) class="uk-active" @endif><a href="{{ URL('/desastronautas') }}"><i class="uk-icon-paper-plane-o"></i> {{ trans('project.navbar.blog') }}</a></li>
    ...
    @yield('content') @include('project.footer') {!! Minify::javascript(['/vendor/jquery/jquery-2.2.1.min.js', '/vendor/uikit/js/uikit.min.js'])->withFullUrl() !!} @yield('javascript')
</body>
</html>