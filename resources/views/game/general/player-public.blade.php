		...
		<div class="uk-width-medium-1-4">
		    <div class="uk-panel uk-panel-box uk-text-center">
		        ...
		        <ul class="uk-list uk-list-striped uk-text-left">
		        	<li><i class="uk-icon-heart"></i> Level: <strong>{{ $player->level }}</strong></li>
		        	<li><i class="uk-icon-bookmark"></i> Patente: <strong>{{ $player_patente }}</strong></li>
		        	<li><i class="uk-icon-money"></i> Dinheiro: <strong>{{ $player->money }}</strong></li>
		        	<li><i class="uk-icon-calendar"></i> Desde: <strong>{{ $player->desde() }}</strong></li>
		        </ul>
		    </div>
		    <div class="uk-panel uk-panel-box uk-text-center">
		    	<img src="{{ url('img/camp-night.png') }}">
		    	(campo)
		    </div>
